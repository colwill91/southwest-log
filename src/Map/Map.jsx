        ...
        <div className="my-container">
          <div className="row center-xs">
            <div className="map col-xs-12 col-sm-5">
              ...
              <h3>Free Delivery</h3>
              <p className="fig">We deliver our firewood across many areas in the southwest including Taunton, Bridgewater, Glastonbury, Bath, Bristol and further surrounding areas. Please see map for area availability and also please contact if your area is not listed, we likely can deliver there also.</p>
